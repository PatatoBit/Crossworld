...
<main class="about">
  ...
  <div class="content">
    ...
    <section class="card" aria-labelledby="about-heading">
      ...
      <p>
        CrossWorld เป็นโปรแกรมเกมเพื่อส่งเสริมทักษะการเรียนรู้
        (รหัสโครงการ 28P22C00781) ที่ผสมผสานการฝึกคำศัพท์ภาษาอังกฤษเข้ากับความรู้ด้านสิ่งแวดล้อม
        และการพัฒนาอย่างยั่งยืน (UN SDGs)
      </p>
      <p>
        ผู้เล่นรับบทผู้พิทักษ์กาลเวลา เดินทางย้อนไปยังทวีปต่าง ๆ
        เพื่อไขปริศนาอักษรไขว้ 3 มิติที่เกี่ยวข้องกับวิกฤตสิ่งแวดล้อมในแต่ละพื้นที่
      ...
      <dl class="meta">
        ...
        <div>
          <dt>ความก้าวหน้าที่บันทึกไว้</dt>
    ...
    <section class="card settings" aria-labelledby="settings-heading">
      ...
      <p>
        ล้างความจำความก้าวหน้าของด่านทั้งหมดที่บันทึกไว้ในเครื่องนี้
...
{#if confirmOpen}
  ...
  >
    <div class="dialog">
      ...
      <p>
        การกระทำนี้จะลบประวัติด่านที่ผ่านแล้วทั้งหมด
